...
public class Prestamos extends Banco implements IBanco{
	...
	public Prestamos(String descripcion, double comision, String fInicio, String fFinal, Cliente clienteAsociado,int clave,
