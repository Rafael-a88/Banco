...
public class Hipotecas extends Banco implements IBanco{
	...
	public Hipotecas (String descripcion, double comision, String fInicio, String fFinal, Cliente clienteAsociado,int clave,
	...
	public String toString() {
		return "Hipotecas [saldoSolicitado=" + saldoSolicitado + ", devolucion=" + devolucion + ", intMensual="
